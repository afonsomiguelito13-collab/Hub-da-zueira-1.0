...
_G.PopupFrame.Size=UDim2.new(0,360,0,200)
_G.PopupFrame.Position=UDim2.new(0.5,-180,0.5,-100)
...
Instance.new("UIStroke",textArea).Color=Color3.fromRGB(60,30,30)
